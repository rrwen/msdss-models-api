...
# -*- coding: utf-8 -*-
#
# msdss_models_api documentation build configuration file
#
...
import os
import sys
sys.path.insert(0, os.path.abspath('../../msdss_models_api'))

author = 'Richard Wen rrwen.dev@gmail.com'
project = 'msdss_models_api'
...
intersphinx_mapping = {
    ...
    'msdss_users_api': ('https://rrwen.github.io/msdss-users-api/', None),
}
...
#
html_theme_options = {
    'nav_title': 'msdss-models-api',
    'base_url': 'https://rrwen.github.io/msdss-models-api',
    'color_primary': 'blue',
    'color_accent': 'light-blue',
    'repo_url': 'https://github.com/rrwen/msdss-models-api/',
    'repo_name': 'msdss-models-api'
}
...
htmlhelp_basename = 'msdss_models_api_doc'
...
latex_documents = [
    (master_doc, 'msdss_models_api.tex', project.replace('_', '\\_') + ' Documentation',
     author, 'manual'),
]
